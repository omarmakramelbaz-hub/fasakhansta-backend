...
class UserResource extends JsonResource
{
    ...
    {
        // The delegate app only needs the account/profile fields below.
        // Returning early here avoids restaurant, cart, address and settings
        // queries that are irrelevant to delegates and can delay app startup.
        if ($this->account_type === 'delegate') {
            return [
                'id' => $this->id,
                'name' => $this->name,
                'email' => $this->email,
                ...
                // Restaurant/vendor-only values are intentionally neutral for delegates.
                'resturant_id' => null,
                'resturant_lat' => null,
                'resturant_lng' => null,
                'resturant_city' => null,
                'resturant_open_at' => null,
                'resturant_close_at' => null,
                'resturant_city_id' => null,
                'resturant_cityname' => null,
                'resturant_phone' => null,
                'resturant_name' => null,
                'resturant_logo' => null,
                'resturant_bg_image' => null,
                'resturant_area_id' => null,
                'resturant_area_name' => null,
                'myresturant_has_menu' => null,
                'resturant_parent_id' => null,
                'parent_has_menu' => null,

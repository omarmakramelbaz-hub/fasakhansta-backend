                                    ...
                                    <div class="form-group col-sm-10">
                                        ...
                                        <div class="mr-4">
                                            ...
                                            @if(explode('-',$value->name)[0] == permissionArrayLoop()[$i])
                                                <label>
                                                    <!-- {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, ['class' => explode('-',$value->name)[0].'-create']) }} -->
                                                <input type="checkbox" value="{{$value->id}}" id="cbx-group-{{permissionArrayLoop()[$i] }}" name="permission[]" class="cbx-group cbx-group-{{permissionArrayLoop()[$i] }}"  @if(in_array($value->id, $rolePermissions)) checked @endif>   

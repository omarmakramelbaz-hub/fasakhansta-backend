        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row justify-content-between align-items-center gy-2 mb-2">
                    <div class="col-auto">
                        <h1 class="m-0 text-dark">@if(request('parent_id')) @lang('main.editcity') @else @lang('main.edit') @endif</h1>
                    </div><!-- /.col -->
                    <div class="col-auto">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="from-prevent-multiple-submits" method="post" action="{{ route('areas.update', $area->id) }}"

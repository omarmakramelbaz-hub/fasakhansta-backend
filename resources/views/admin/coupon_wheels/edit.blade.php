    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">@lang('main.Editcoupon_wheel')</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="from-prevent-multiple-submits" method="post" action="{{ route('coupon_wheels.update', $coupon_wheel->id) }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    @include('admin.coupon_wheels.form')
                                </form>
                            </div>
                        </div>
                    </div>
...
$('.del-image').on('click',function(){
            ...
            swal({
                ...
                dangerMode: true,
                  ...
                  if (result) {
                      $.ajax({
                      url:"{{ url('/admin/coupon_wheels/del/image')}}",
                      type:'delete',
                      data:{ _token:"{{ csrf_token() }}","id":id,"coupon_wheel_id":"{{$coupon_wheel->id}}" },

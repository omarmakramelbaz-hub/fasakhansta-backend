    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">@lang('main.add') @lang('main.resturant') </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        @can('resturant-list')
                            <li class="breadcrumb-item">
                                <ol class="breadcrumb float-sm-left"><a
                                        href="{{ url('admin/resturants?resturant_id=' . request('resturant_id'))}}"
                                        class="btn btn-primary">@lang('main.showAll')
...
@push('custom-js')
    <script type="text/javascript">
        ...
        $(".add-select").click(function () {
            ...
            $(".clone-row .clone:last label.expected_delivery").text('@lang("main.expected_delivery_km")'); // Update the label text
            $('.clone-row .areas').select2();
        });

        // Handle click event for deleting rows
        $(document).on('click', '.btn-del-select', function (e) {
            $(this).closest(".row.clone").remove(); // Remove the closest .row.clone element

                            ...
                            @if($user->account_type == 'user')
                                    ...
                                    <div class="tab-pane fade active show" id="pills-userorders" role="tabpanel" aria-labelledby="pills-userorders-tab">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    @forelse($user->orders->whereNotNull('status')->where('status','!=','pending')->where('type','current') as $order)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>
                                                                {{$order->order_no}}
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            @forelse(\App\Models\Wallet::where('status','completed')->where('from_user',$user->id)->orWhere('to_user',$user->id)->get() as $transaction)
                                                <tr>
                                                    <td>{{ $loop->iteration }}</td>
                                                    <td>
                                    ...
                                    <div class="tab-pane fade active show" id="pills-delegateOrders" role="tabpanel" aria-labelledby="pills-delegateOrders-tab">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    @forelse($user->delegate_orders as $order)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>
                                                                {{$order->order_no}}
        ...
        <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @php $orders = \App\Models\Order::where('resturant_id',$user->base_resturant?->id)->get(); @endphp
                                        @if($orders)
                                        <tr>

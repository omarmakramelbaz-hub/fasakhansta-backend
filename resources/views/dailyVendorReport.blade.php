    ...
    <main class="invoice">
      <div class="container-lg">
        <div class="invoice_header">
          <div class="invoice_logo">
            @if($vendor->base_resturant?->getFirstMediaUrl('logo','thumb'))
                <img src="{{$vendor->base_resturant?->getFirstMediaUrl('logo','thumb')}}"
                    alt="{{$vendor->base_resturant?->name}}">
            @endif
          </div>
          <div class="client_detail">
            <table class="table">
              <tbody>
                ...
                <tr>
                  <th>@lang('main.branch')</th>
                  <td>: {{$vendor->base_resturant?->name}} ({{$vendor->base_resturant?->area?->title}})</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div class="container-lg">
        <div class="table-responsive">
          <table class="table">
            ...
            @foreach($orders as $key => $value)
              <tr>
                ...
                <td>{{$value->vendor_percentage}} @lang('main.egp')</td>
              </tr>
            @endforeach
            </tbody>
          </table>
          ...
          {{--<table class="table">
            <caption style="caption-side:top">ملخص الطلبات</caption>
            <thead>
              <tr>
               <th>#</th>   
              <th>عدد الطلبات</th>
            ...
            <div class="wallet">
                <table role="presentation" class="table" cellspacing="0" cellpadding="0" style="margin:0">
                    ...
                    <tr>
                        ...
                        <td>{{$orders->sum('vendor_percentage')}} @lang('main.egp')</td>
                    </tr>
                </tbody>
                </table>
            </div>

...
class StoreAuthRequest extends FormRequest
{
  use ApiResponses;
    ...
    {  $delegate_vendor_small_info=app(GeneralSettings::class)->delegate_vendor_small_info;
        $validation= [
        ...
        if($delegate_vendor_small_info==0){
            $validation+=[
                   'national_id'           =>'required|unique:pending_vendors,national_id|numeric|digits:14',
                    ...
                    'national_id_image'           =>'required|image|mimes:png,jpg,webp',
                    'commercial_registration_no_image' =>request()->type=='vendor'?'required|image|mimes:png,jpg,webp':'nullable|image|mimes:png,jpg,webp5',
                    'driving_license_image'    =>request()->type=='delegate'?'required|image|mimes:png,jpg,webp':'nullable|image|mimes:png,jpg,webp',
                    'tax_no_image' =>request()->type=='vendor'?'required|image|mimes:png,jpg,webp':'nullable|image|mimes:png,jpg,webp',

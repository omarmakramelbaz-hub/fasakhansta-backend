...
class NotifySheduleOrderNotification extends Notification
{
    use Queueable;
    use FcmFirebase;
    ...
    {  
        ...
        $this->body_data =[
                'title'     =>  'لديك إشعار تذكير بطلب مجدول ',
                'redirect' => 'orders/'.$this->msg->id,
                'logo'     => $this->msg->resturant?->getFirstMediaUrl('logo','thumb'),
                'text'      =>  'نذكرك بتسليم طلب رقم #'. $this->msg->order_no.' تاريخ التسليم غدًا ',

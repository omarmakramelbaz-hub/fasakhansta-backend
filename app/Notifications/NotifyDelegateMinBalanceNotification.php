...
class NotifyDelegateMinBalanceNotification extends Notification
{
    use Queueable;
    use FcmFirebase;
    /**
    ...
    public function toDatabase($notifiable)
    {
        ...
        $types  = [];
        $fdate = now();
        $tdate = $this->msg->expiration_date;
        ...
        $this->body_data =[
                ...
                'text'      => 'رصيد محفظتك اصبح أقل من الحد الأدني المطلوب ، اشحن رصيدك في خلال فتره السماح وهيا '.  $diff. ' أيام بدأ من اليوم',
                'created_at' => now(),
                'data'      => [ 

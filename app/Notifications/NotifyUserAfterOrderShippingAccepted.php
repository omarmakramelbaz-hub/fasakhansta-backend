...
class NotifyUserAfterOrderShippingAccepted extends Notification
{
    use Queueable;
    use FcmFirebase;
    ...
    {  
        ...
        $this->body_data =[
                ...
                'text'      =>  'تم الموافقة علي طلب التوصيل رقم '. $this->msg->order_no .' من قبل المندوب '. $this->msg->delegate?->name,

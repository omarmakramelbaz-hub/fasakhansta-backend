...
class NotifyAdminSentPercentageOrdersNotification extends Notification
{
    use Queueable;
    use FcmFirebase;
    ...
    {  
        ...
        $this->body_data =[
                ...
                'logo'     => url('/public/site/images/fav.svg'),
                'text'      =>  'تم إرسال النسبة الخاصة بكم علي الطلب رقم    '. $this->msg->order_no,

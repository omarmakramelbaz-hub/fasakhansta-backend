...
class NotifyResturantReviewSentNotification extends Notification
{
    use Queueable;
    use FcmFirebase;
    /**
     ...
     */
    private $msg;
    public function __construct(Review $msg)
    {
        $this->msg=$msg;
    }
    /**
    ...
    public function toDatabase($notifiable)
    {
        ...
        $this->body_data =[
                'title'     =>  'لديك إشعار تقييم الطلب ',
                'logo'     => $this->msg->resturant?->getFirstMediaUrl('logo','thumb'),
                'text'      =>  'تم تقييم الطلب رقم   ' . $this->msg->order?->order_no,

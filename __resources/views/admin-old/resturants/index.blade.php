                                    ...
                                    <tbody>
                                        @forelse ($resturants as $resturant)
                                            <tr>
                                                ...
                                                <td @if($resturant->status == 'closed') style="background: #db0f0f;color: white;" @elseif($resturant->status == 'opened') style="background: #45db0f;color: white;" @elseif($resturant->status == 'busy') style="background: #db820f;color: white;" @elseif($resturant->status == 'disabled') style="background: #ffdd40;color: white;"  @endif>
                                                ...
                                                <td width="250px">
                                                    @can('resturant-list')
                                                      @if(auth()->user()->roles->pluck("id")->first() == 11)
                                                        ...
                                                        @else
                                                        <span>@lang('main.main branch') {{$resturant->parent?->name}} </span>
                                                        @endif
                                                      @endif
